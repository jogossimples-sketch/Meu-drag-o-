# MEU DRAGÃO - JOGO ESTILO POU

## COMO CRIAR AS IMAGENS:
Crie uma pasta chamada `images` e dentro dela crie um arquivo `gerar_imagens.py` com o código abaixo. Depois rode `python images/gerar_imagens.py` para criar todas as imagens.
